...
using NorbitsChallenge.Models.Repo;
using NorbitsChallenge.Services;
...
namespace NorbitsChallenge
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IWorkshopRepository<Car>, WorkshopRepository<Car>>();
            services.AddScoped<IWorkshopRepository<Settings>, WorkshopRepository<Settings>>();
